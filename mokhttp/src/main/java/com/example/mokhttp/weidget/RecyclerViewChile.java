...
public class RecyclerViewChile extends RecyclerView implements NestedScrollingChild2 {
    ...
    public RecyclerViewChile(@NonNull Context context) {
        super(context);
        initChildHelper();
    ...
    public RecyclerViewChile(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initChildHelper();
    }

    public RecyclerViewChile(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (actionMasked) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                // 获得当前手指的Y
                final float pointerY = getPointerY(e, pointerId);
